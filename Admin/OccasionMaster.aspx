<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OccasionMaster.aspx.cs" Inherits="Admin_OccasionMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Occasion MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Occasion Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Occasion_Name" HeaderText="Occasion_Name" 
                            SortExpression="Occasion_Name" /> 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [OccasionMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [OccasionMaster] ([Sr_No], [Occasion_Name]) VALUES (@Sr_No, @Occasion_Name)" 
                    SelectCommand="SELECT * FROM [OccasionMaster] ORDER BY [Sr_No], [Occasion_Name]" 
                    
                    UpdateCommand="UPDATE [OccasionMaster] SET [Occasion_Name] = @Occasion_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </DeleteParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="Occasion_Name" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
