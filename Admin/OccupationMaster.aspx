<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OccupationMaster.aspx.cs" Inherits="Admin_OccupationMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Occupation MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Occupation Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Occupation_Name" HeaderText="Occupation_Name" 
                            SortExpression="Occupation_Name" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [OccupationMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [OccupationMaster] ([Sr_No], [Occupation_Name]) VALUES (@Sr_No, @Occupation_Name)" 
                    SelectCommand="SELECT * FROM [OccupationMaster] ORDER BY [Sr_No], [Occupation_Name]" 
                    
                    UpdateCommand="UPDATE [OccupationMaster] SET [Occupation_Name] = @Occupation_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </DeleteParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="Occupation_Name" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
