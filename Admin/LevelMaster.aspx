<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="LevelMaster.aspx.cs" Inherits="Admin_LevelMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Level MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Level Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [RSSLevelMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [RSSLevelMaster] ([Sr_No], [Level_Name]) VALUES (@Sr_No, @Level_Name)" 
                    SelectCommand="SELECT * FROM [RSSLevelMaster] ORDER BY [Sr_No], [Level_Name]" 
                    
                    UpdateCommand="UPDATE [RSSLevelMaster] SET [Level_Name] = @Level_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
