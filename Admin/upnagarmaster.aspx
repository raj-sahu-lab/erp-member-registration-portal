<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="upnagarmaster.aspx.cs" Inherits="Admin_upnagarmaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center" colspan="2">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="UPNagar MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
          ...
          <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Select Rashtra"></asp:Label>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="txtlabel_name" runat="server" Width="195px"></asp:DropDownList>
            </td>
            </tr>
        <tr>
             <td>
                <asp:Label ID="Label4" runat="server" Text="UpNagar"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtupnagar" runat="server" Width="170px" ></asp:TextBox>
            </td>
        </tr>      
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1"  Style="overflow:auto;width:500px" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                       ...
                       <asp:BoundField DataField="kshetraorg" HeaderText="Org kshetra"/>
                        ...
                        <asp:BoundField DataField="Nagar" HeaderText="Nagar" 
                            SortExpression="Nagar" />
                        <asp:BoundField DataField="upNagar" HeaderText="Upnagar"/>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [upNagarMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [upNagarMaster] ([Sr_No], [Country], [State_Name], [District], [Nagar], [Nagar_Code]) VALUES (@Sr_No, @Country, @State_Name, @District, @Nagar)" 
                    SelectCommand="SELECT * FROM [upNagarMaster] ORDER BY [Sr_No], [Nagar]" 
                    UpdateCommand="UPDATE [upNagarMaster] SET [Country] = @Country, [State_Name] = @State_Name, [District] = @District, [Nagar] = @Nagar WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                    ...
                    <UpdateParameters>
                        ...
                        <asp:Parameter Name="Nagar" Type="String" />
