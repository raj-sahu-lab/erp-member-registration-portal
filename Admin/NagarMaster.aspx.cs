...
public partial class Admin_NagarMaster : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.ConnectionString = ConfigurationManager.ConnectionStrings["BITRSS"].ConnectionString.Trim();
            con.Open();
            cmd.CommandText = "Insert into NagarMaster(Sr_No, Country, kshetraorg,kshetrarss,prantrss,prantorg,prantgovt ,Loksabha, vidhansabha, District, Tehsil, Nagar) values('" + txtcomm_id.Text + "','" + ddl_country.Text + "','" + ddl_kshetraorg.SelectedItem.Text + "','" + ddl_kshetrarss.SelectedItem.Text + "','" + ddl_prant_rss.SelectedItem.Text + "','" + ddl_prant_org.SelectedItem.Text + "','" + ddl_prant_govt.SelectedItem.Text + "','" + ddl_lokshabhaname.SelectedItem.Text + "','" + ddl_vidhansabha.SelectedItem.Text + "','" + ddl_distr.SelectedItem.Text + "','" + ddl_tehsil.SelectedItem.Text + "','" + txtlabel_name.Text + "')";
            cmd.Connection = con;
            cmd.ExecuteNonQuery();
