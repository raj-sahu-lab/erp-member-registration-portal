...
public partial class Admin_SanghShikshaMasterMaster : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.ConnectionString = ConfigurationManager.ConnectionStrings["BITRSS"].ConnectionString.Trim();
            con.Open();
            cmd.CommandText = "Insert into SanghShikshaMasterMaster(Sr_No, SanghShikshaMaster_Name) values(@srNo,@ssName)";
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@srNo", txtcomm_id.Text);
            cmd.Parameters.AddWithValue("@ssName", txtlabel_name.Text);
            cmd.Connection = con;
            cmd.ExecuteNonQuery();
