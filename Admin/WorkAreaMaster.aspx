<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="WorkAreaMaster.aspx.cs" Inherits="Admin_WorkAreaMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Vicharpariwar Master"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="WorkArea Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="WorkArea_Name" HeaderText="WorkArea_Name" 
                            SortExpression="WorkArea_Name" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [WorkAreaMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [WorkAreaMaster] ([Sr_No], [WorkArea_Name]) VALUES (@Sr_No, @WorkArea_Name)" 
                    SelectCommand="SELECT * FROM [WorkAreaMaster] ORDER BY [Sr_No], [WorkArea_Name]" 
                    
                    UpdateCommand="UPDATE [WorkAreaMaster] SET [WorkArea_Name] = @WorkArea_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </DeleteParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="WorkArea_Name" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
