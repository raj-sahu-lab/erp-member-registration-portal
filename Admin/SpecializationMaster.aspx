<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SpecializationMaster.aspx.cs" Inherits="Admin_SpecializationMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Specialization MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Specialization Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Specialization_Name" HeaderText="Specialization_Name" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [SpecializationMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [SpecializationMaster] ([Sr_No], [Specialization_Name]) VALUES (@Sr_No, @Specialization_Name)" 
                    SelectCommand="SELECT * FROM [SpecializationMaster] ORDER BY [Sr_No], [Specialization_Name]" 
                    
                    UpdateCommand="UPDATE [SpecializationMaster] SET [Specialization_Name] = @Specialization_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
