<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="HobbyMaster.aspx.cs" Inherits="Admin_HobbyMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Hobby MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Hobby Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Hobby_Name" HeaderText="Hobby_Name" 
                            SortExpression="Hobby_Name" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [HobbyMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [HobbyMaster] ([Sr_No], [Hobby_Name]) VALUES (@Sr_No, @Hobby_Name)" 
                    SelectCommand="SELECT * FROM [HobbyMaster] ORDER BY [Sr_No], [Hobby_Name]" 
                    
                    UpdateCommand="UPDATE [HobbyMaster] SET [Hobby_Name] = @Hobby_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </DeleteParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="Hobby_Name" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
