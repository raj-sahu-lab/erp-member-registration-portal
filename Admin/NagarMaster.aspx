<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="NagarMaster.aspx.cs" Inherits="Admin_NagarMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center" colspan="4">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Nagar MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                  <asp:DropDownList ID="ddl_tehsil" runat="server" Width="195px">
                        </asp:DropDownList>
            </td>
      ...
      <%--  <tr>
             <td>
                <asp:Label ID="Label4" runat="server" Text="Nagar Code"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [NagarMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [NagarMaster] ([Sr_No], [Country], [State_Name], [District], [Nagar], [Nagar_Code]) VALUES (@Sr_No, @Country, @State_Name, @District, @Nagar, @Nagar_Code)" 
                    SelectCommand="SELECT * FROM [NagarMaster] ORDER BY [Sr_No], [Nagar_Code], [Nagar]" 
                    UpdateCommand="UPDATE [NagarMaster] SET [Country] = @Country, [State_Name] = @State_Name, [District] = @District, [Nagar] = @Nagar, [Nagar_Code] = @Nagar_Code WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                    ...
                    <UpdateParameters>
                        ...
                        <asp:Parameter Name="Nagar_Code" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
