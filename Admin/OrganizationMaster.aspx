<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OrganizationMaster.aspx.cs" Inherits="Admin_OrganizationMaster" %>
        ...
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Organization MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [OrganizationMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [OrganizationMaster] ([Sr_No], [Organization_Name]) VALUES (@Sr_No, @Organization_Name)" 
                    SelectCommand="SELECT * FROM [OrganizationMaster] ORDER BY [Sr_No], [Organization_Name]" 
                    
                    UpdateCommand="UPDATE [OrganizationMaster] SET [Organization_Name] = @Organization_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
