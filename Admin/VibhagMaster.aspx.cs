...
public partial class Admin_VibhagMaster : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.ConnectionString = ConfigurationManager.ConnectionStrings["BITRSS"].ConnectionString.Trim();
            con.Open();
            cmd.CommandText = @"Insert into VibhagMaster(Sr_No, Country, Zone, State, Kshetra, Vibhag_Name) values('@commid','@country','@zone','@prant','@prant','@labelname')";
            ...
            cmd.Parameters.AddWithValue("@prant", ddl_prant.Text);
            cmd.Parameters.AddWithValue("@prant", ddl_prant.Text);
    ...
    protected void ddl_prant_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            con.ConnectionString = ConfigurationManager.ConnectionStrings["BITRSS"].ConnectionString.Trim();
            con.Open();
            cmd.CommandText = @"Select Distinct Kshetra_Name from KshetraMaster Where Country='@country' AND Zone='@zone' AND State='@prant' Order By Kshetra_Name";
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@country", ddl_country.Text);
            cmd.Parameters.AddWithValue("@zone", ddl_zone.Text);
            cmd.Parameters.AddWithValue("@prant", ddl_prant.Text);
