<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="VarshMaster.aspx.cs" Inherits="Admin_VarshMaster" %>
...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Organization training Master"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Varsh Name"></asp:Label>
            </td>
            <td>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Varsh_Name" HeaderText="Varsh_Name" 
                            SortExpression="Varsh_Name" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [VarshMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [VarshMaster] ([Sr_No], [Varsh_Name]) VALUES (@Sr_No, @Varsh_Name)" 
                    SelectCommand="SELECT * FROM [VarshMaster] ORDER BY [Sr_No], [Varsh_Name]" 
                    
                    UpdateCommand="UPDATE [VarshMaster] SET [Varsh_Name] = @Varsh_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </DeleteParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="Varsh_Name" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
