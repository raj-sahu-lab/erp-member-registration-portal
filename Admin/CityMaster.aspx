...
<ContentTemplate>
    <table align="center">
        <tr>
            <td align="center" colspan="4">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="VIDHANSABHA MASTER"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
         ...
         <tr>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label6" runat="server" Text="Select ORG wise Kshetra/Zonee"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label9" runat="server" Text="RSS Wise Prant Name "></asp:Label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                        <asp:Label ID="Label10" runat="server" Text="ORG Wise Prant Name "></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label11" runat="server" Text="Govt Wise Prant Name "></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label12" runat="server" Text="Loksabha Name"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddl_loksabha" runat="server" Width="195px" AutoPostBack="true" OnSelectedIndexChanged="ddl_loksabha_SelectedIndexChanged">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Vidhansabha Name"></asp:Label>
            </td>
            <td>
        ...
        <tr>
             <td>
                <asp:Label ID="Label4" runat="server" Text="Vidhansabha Code"></asp:Label>
            </td>
            <td>
            ...
            <td align="center" colspan="4">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Vidhansabha_Code" HeaderText="Code" 
                            SortExpression="Vidhansabha_Code" />  
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [CityMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [CityMaster] ([Sr_No], [Country], [State_Name], [District], [Vidhansabha], [Vidhansabha_Code]) VALUES (@Sr_No, @Country, @State_Name, @District, @Vidhansabha, @Vidhansabha_Code)" 
                    SelectCommand="SELECT * FROM [CityMaster] ORDER BY [Sr_No], [Vidhansabha_Code], [Vidhansabha]" 
                    UpdateCommand="UPDATE [CityMaster] SET [Country] = @Country, [State_Name] = @State_Name, [District] = @District, [Vidhansabha] = @Vidhansabha, [Vidhansabha_Code] = @Vidhansabha_Code WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
                    ...
                    <UpdateParameters>
                        ...
                        <asp:Parameter Name="Vidhansabha_Code" Type="String" />
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="Sr_No" Type="Decimal" />
