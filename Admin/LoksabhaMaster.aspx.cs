...
public partial class Admin_LoksabhaMaster : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.ConnectionString = ConfigurationManager.ConnectionStrings["BITRSS"].ConnectionString.Trim();
            con.Open();
            cmd.CommandText = @"Insert into LoksabhaMaster(Sr_No, Country, kshetraorg,kshetrarss,prantrss,prantorg,prantgovt ,Loksabha, Loksabha_Code) values('@commid','@country','@kshetraorg','@kshetrarss','@prantrss','@prantorg','@prantgovt','@labelname','@code')";
            cmd.Parameters.Clear();
