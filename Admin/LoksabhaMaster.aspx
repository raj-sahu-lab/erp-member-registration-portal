        ...
        <ContentTemplate>
            <table align="center">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddl_prant_govt" runat="server" Width="195px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="center" colspan="2">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Sr_No" HeaderText="Enrty No" ReadOnly="True"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                            ...
                            SelectCommand="SELECT * FROM [LoksabhaMaster] ORDER BY [Sr_No], [Loksabha]"
