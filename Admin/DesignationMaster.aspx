<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="DesignationMaster.aspx.cs" Inherits="Admin_DesignationMaster" %>
            ...
            <td>
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [DesignationMaster] WHERE [Sr_No] = @Sr_No" 
                    InsertCommand="INSERT INTO [DesignationMaster] ([Sr_No], [Designation_Name]) VALUES (@Sr_No, @Designation_Name)" 
                    SelectCommand="SELECT * FROM [DesignationMaster] ORDER BY [Sr_No], [Designation_Name]" 
                    
                    UpdateCommand="UPDATE [DesignationMaster] SET [Designation_Name] = @Designation_Name WHERE [Sr_No] = @Sr_No">
                    <DeleteParameters>
