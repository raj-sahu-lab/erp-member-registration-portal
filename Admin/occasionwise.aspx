<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/ReportMasterPage.master" AutoEventWireup="true" CodeFile="occasionwise.aspx.cs" Inherits="Admin_occasionwise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <tr>
                    <td align="center" colspan="4">
                        <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px"
                            Font-Underline="True" ForeColor="#003399" Text="OCCASION WISE FILTER"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
   ...
   <tr>
                            ...
                            <tr>
                               ...
                               <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Text="Select occasion"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddl_ocass" runat="server" Width="195px" AutoPostBack="true" OnSelectedIndexChanged="ddl_ocass_SelectedIndexChanged">
            ...
            <table style="width:100%">
                <tr>
                    <th colspan="2" style="text-align:center"><h2>Send SMS</h2></th>
                </tr>
                <tr>
                    <td style="width:80%"><asp:TextBox ID="txtmessage" runat="server" TextMode="MultiLine" Width="80%" Height="100px"></asp:TextBox></td>
                    <td style="width:20%"><asp:Button ID="btnsend" runat="server" Text="Send to All" OnClick="btnsend_Click" /></td>
                </tr>
            </table>
